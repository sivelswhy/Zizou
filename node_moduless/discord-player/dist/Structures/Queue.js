...
class Queue {
    ...
    constructor(player, guild, options = {}) {
        ...
        this.player.emit("debug", this, `La queue à été initialisé :\n\n${this.player.scanDeps()}`);
    }
    /**
    ...
    connect(channel) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (!["GUILD_STAGE_VOICE", "GUILD_VOICE"].includes(_channel === null || _channel === void 0 ? void 0 : _channel.type))
                throw new PlayerError_1.PlayerError(`Le channel doit-être uniquement GUILD_VOICE ou GUILD_STAGE_VOICE, j'ai eu ${_channel === null || _channel === void 0 ? void 0 : _channel.type}!`, PlayerError_1.ErrorStatusCode.INVALID_ARG_TYPE);
    ...
    addTracks(tracks) {
        ...
        if (!tracks.every((y) => y instanceof Track_1.default))
            throw new PlayerError_1.PlayerError("track invalide", PlayerError_1.ErrorStatusCode.INVALID_TRACK);
    ...
    setRepeatMode(mode) {
        ...
        if (![types_1.QueueRepeatMode.OFF, types_1.QueueRepeatMode.QUEUE, types_1.QueueRepeatMode.TRACK, types_1.QueueRepeatMode.AUTOPLAY].includes(mode))
            throw new PlayerError_1.PlayerError(`Mode de répétition inconnu "${mode}"!`, PlayerError_1.ErrorStatusCode.UNKNOWN_REPEAT_MODE);
    ...
    back() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (!prev)
                throw new PlayerError_1.PlayerError("Je n'ai pas pu trouver la piste précédente", PlayerError_1.ErrorStatusCode.TRACK_NOT_FOUND);
    ...
    jump(track) {
        ...
        if (!foundTrack)
            throw new PlayerError_1.PlayerError("Piste introuvé", PlayerError_1.ErrorStatusCode.TRACK_NOT_FOUND);
    ...
    *[(_Queue_lastVolume = new WeakMap(), _Queue_destroyed = new WeakMap(), _Queue_instances = new WeakSet(), Symbol.iterator)]() {
    ...
    toString() {
        ...
        if (!this.tracks.length)
            return "__***Il n'y a aucun song à afficher hormis celui en cours.***__";
        return `**Prochains songs :\n**\n${this.tracks.map((m, i) => `${i + 1}. **${m.title}**`).join("\n")}`;
    }
}
exports.Queue = Queue;
